...
public class Operator2 {
    public static void main(String[] args) {
        ...
        //실습2) 게시글 162개가 있을때
        //한페이지에 20개씩 보인다면,총 페이지의 갯수를 pageCount에 대입
        //postCount를 바꾸어도 작동할 수 있게
        int postCount = 162;
        int pageCount;
        //20개로 나누어 떨어지면 -> 20개로 나눈값;
        //20개로 나누어 떨어지지 X -> 20개로 나눈 값 + 1
        pageCount = postCount % 20 == 0
                ?postCount / 20 //그럼 그냥 나눈값
                : postCount/ 20 + 1; // 나누어 떨?
